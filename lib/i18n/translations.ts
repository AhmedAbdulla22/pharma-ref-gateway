...
export const translations = {
  en: {
    ...
    safety: "Safety",
    keyUses: "Key Uses",
    dosageGuide: "Dosage Guide",
    safetyAlerts: "Safety Alerts",
    avoidIf: "Avoid If...",
    interactions: "Interactions",
    pregnancyNursing: "Pregnancy & Nursing",
    fdaClinicalReference: "FDA Clinical Reference",
    dosageAdministration: "Dosage and Administration",
    indicationsUsage: "Indications and Usage",
  ...
  ar: {
    ...
    clinical: "سريري",
    safety: "السلامة",
    keyUses: "الاستخدامات الرئيسية",
    dosageGuide: "دليل الجرعة",
    safetyAlerts: "تنبيهات السلامة",
    avoidIf: "تجنب إذا...",
    interactions: "التفاعلات",
    pregnancyNursing: "الحمل والرضاعة",
    fdaClinicalReference: "المرجع السريري لـ FDA",
    dosageAdministration: "الجرعة والإعطاء",
    indicationsUsage: "الاستطبابات والاستخدام",
    warningsPrecautions: "التحذيرات والاحتياطات",
    adverseReactions: "التفاعلات العكسية",
    ingredients: "المكونات",
    active: "نشط",
    inactive: "غير نشط",
    populationSafety: "سلامة السكان",
    pediatric: "الأطفال",
    geriatric: "المسنين",
    pregnancy: "الحمل",
    supplyRoute: "التوريد وطريقة الإعطاء",
    route: "طريقة الإعطاء",
    use: "الاستخدام",
  },
  ku: {
    ...
    // Drug Details Page
    aiSummary: "کورتەی زیرەکی دەستکرد",
    clinical: "کلینیکی",
    safety: "سەلامەتی",
    keyUses: "بەکارهێنانە سەرەکییەکان",
    dosageGuide: "ڕێنمای دۆز",
    safetyAlerts: "ئاگادارییەکانی سەلامەتی",
    avoidIf: "دوورکەوتنەوە ئەگەر...",
    interactions: "کارلێکەکان",
    pregnancyNursing: "سکپڕی و شیردان",
    fdaClinicalReference: "سەرچاوەی کلینیکی FDA",
    dosageAdministration: "دۆز و دابینکردن",
    indicationsUsage: "نیشانەکان و بەکارهێنان",
    warningsPrecautions: "ئاگاداری و پاراستن",
    adverseReactions: "کارلێکی نەرێنی",
    ingredients: "پێکهاتەکان",
    active: "چالاک",
    inactive: "ناچالاک",
    populationSafety: "سەلامەتی دانیشتوان",
    pediatric: "منداڵان",
    geriatric: "تەمەنەکان",
    pregnancy: "سکپڕی",
    supplyRoute: "دابینکردن و ڕێگا",
    route: "ڕێگا",
    use: "بەکارهێنان",
  },
} as const
